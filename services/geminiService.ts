...
# 指示
- **AIとしての前置きや挨拶（「はい、承知いたしました」など）、太字のセクションタイトル（例：「**人物像**」）、括弧付きの見出し（例：「（実績）」）は一切含めず、以下の出力例のような自然な推薦文の本文のみを出力してください。**
...
実務に根差した管理部門体制構築とIPO、市場変更の完遂。リーマンショック時には、厳しい状況下でも資金繰りを安定させ、事業継続の基盤を守り抜きました。

経営陣として高い視座を持ちつつも、管理部門の実務を深く理解しているため、現場の課題を素早く見抜き、地に足のついた解決策を実行できます。

〇〇様は、実務で培った強固な管理部門基盤と、M&Aや組織改革で培った経営者としての視点・実行力を兼ね備えており、貴社の更なる成長・企業価値向上に大きく貢献できるポテンシャルを持っています。ぜひ一度、直接お会いいただく機会をいただけますと幸いです。
`;
};
