...
- 候補者情報から氏名、年齢、学歴、現職、年収などの情報が読み取れる場合は、その情報を記載してください。不明な場合は「〇〇様」「〇〇歳」「〇〇大学卒業」「株式会社〇〇」「〇〇〇〇万円」のようにダミー情報を補完してください。想像で書くことは絶対にやめてください。
- 前文の後の◆○○太郎様（）／〇歳からの5行絶対に書いてください。もちろんその後の【略歴】なども【】をつけて出力フォーマット例に従って出力してください。
