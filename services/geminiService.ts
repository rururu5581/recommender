...
管理部門の実務を深く理解した上で、取締役CFOとして経営全般に関与し、企業価値向上に大きく貢献されてきました。特に、IPO・市場変更を成功させ、・・・・・・・・・
...
実務で培った強固な管理部門基盤と、M&Aや組織改革で培った経営者としての視点・実行力を兼ね備えており、貴社の更なる成長・企業価値向上に大きく貢献できるポテンシャルを持っています。
`;
};
